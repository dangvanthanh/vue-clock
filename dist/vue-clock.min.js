...
`]},media:void 0})},N="data-v-91068ba8",O=void 0,$=!1,H=w({render:v,staticRenderFns:B},x,R,N,$,O,!1,S,void 0,void 0);function A(e){if(A.installed)return;A.installed=!0,e.component("VueClock",H)}const g={install:A};let m=null;return typeof window!="undefined"?m=window.Vue:typeof global!="undefined"&&(m=global.Vue),m&&m.use(g),l.default=g,l.install=A,Object.defineProperty(l,"__esModule",{value:!0}),l}({});
